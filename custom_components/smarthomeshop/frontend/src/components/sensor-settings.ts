      ...
      <div class="zone-editor">
        <div class="zone-header">
          <div class="zone-title">
            ...
            Zone ${z.id}
            <span class="zone-badge ${active ? 'active' : 'inactive'}">${active ? 'Active' : 'Empty'}</span>
          </div>
          <button class="save-zone-btn" @click=${() => this._saveZone(z)} ?disabled=${this._saving}>Save</button>
        </div>
        <div class="zone-grid">
        ...
        <div class="modal">
          ...
          <div class="modal-content">
            ${this._activeTab === 'mmwave' ? html`
              ...
              ` : html`<div class="empty-state">No mmWave settings found</div>`}
            ` : nothing}
            ...
            ${this._activeTab === 'calibration' ? html`
              ...
              ` : html`<div class="empty-state">No calibration settings found</div>`}
            ` : nothing}
          </div>
