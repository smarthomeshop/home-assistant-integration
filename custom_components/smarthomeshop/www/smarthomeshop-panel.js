        ...
        <div class="body">
          ...
          ${"ok"===t&&i?U`
            <div class="chips">
              ...
              ${e?.contract?.tariffs?.water>0?U`<div class="chip"><div class="chip-label">Water</div><div class="chip-value">€ ${Number(e.contract.tariffs.water).toFixed(4)} <span class="unit">/m³</span></div></div>`:B}
            </div>
            ${e?.summary?U`
